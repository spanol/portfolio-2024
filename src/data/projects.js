export const projects = [
  ...
  {
    title: "Weather App",
    description: "Uma das primeiras aplicações que fiz. Ela mostra a previsão do tempo em tempo real, utilizando a API OpenWeatherMap. Desenvolvida com React e Tailwind CSS.",
